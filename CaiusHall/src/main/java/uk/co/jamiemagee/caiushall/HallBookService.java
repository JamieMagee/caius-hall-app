            ...
            for (int i = 0; i < 5; i++) {
                ...
                try {
                    if (action.equals("first")){
                        ...
                        if (returnStatus) mGaTracker.sendEvent("Application events", "Auto booking", "First/Cafeteria", null);
                    } else if (action.equals("formal")){
                        DisplayHallInfoActivity.netBookHall(theDay, false, veggie);
                        returnStatus = DisplayHallInfoActivity.netPullOneBooking(theDay);
                        if (returnStatus) mGaTracker.sendEvent("Application events", "Auto booking", "Formal", null);
